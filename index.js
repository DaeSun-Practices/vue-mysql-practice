const express = require('express'), //웹서버를 가져온다.
      app = express(),              //웹서버 init
      util = require('util'),
...
const testJson = require('./test/test.json');//json을 가져온다.
      
app.use(express.static('public'));          //public 폴더를 static으로 지정
